...
//	private static String uploads_temp = "uploads_temp";
	...
	public static String upload(String type, MultipartFile file) {
		return uploadImpl(type, file, Config.getProperty(upload_direct));
	}
	
	public static String contract(String type, MultipartFile file) {
		return uploadImpl(type, file, Config.getProperty(upload_contract));
	}
	...
	public static String uploadImage(MultipartFile file) {
		return uploadImpl("image", file, Config.getProperty(upload_direct));
	}
	
	public static String temp(String type, MultipartFile file) {
		return uploadImpl(type, file, Config.getProperty(upload_temp));
	}
	...
	public static String tempImage(MultipartFile file) {
		return uploadImpl("image", file, Config.getProperty(upload_temp));
	}
	...
	public static boolean confirm(String path) {
		return pathImpl(path, Config.getProperty(upload_confirm));
	}
	...
	public static boolean trash(String path) {
		return pathImpl(path, Config.getProperty(upload_trash));
	}
